...
PATH = "Generated_Data/caushy_mac-3.jld" # path where data will be saved
...
function run_integrations(cut_range::StepRange{Int64,Int64}, n_repeat::Int64; 
	...
	for cut_run in cut_range
		...
		for n_run in 1:n_repeat
            ...
            log_smpl_int = ahmi_integral_ser .* exp(lgV) ./exp(true_int) # [0.0, 0.0]
...
cut_range = range(0, step=1, stop=6)

@CPUtime run_integrations(cut_range, 10)